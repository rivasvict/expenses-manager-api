...
module.exports = {
  ...
  DB_PREFIX: environment.DB_PREFIX || 'mongodb',
  ...
  DB_PORT: isIntegration ? environment.DB_TEST_PORT : environment.DB_PORT || '27017',
  DB_NAME: isIntegration ? environment.DB_TEST_NAME : environment.DB_NAME,
  DB_CONNECTION_OPTIONS: environment.DB_CONNECTION_OPTIONS || '',
